...
- GitHub user [**ZerxiesDerxies**](https://github.com/zerxiesderxies), author of the [**relevant A1111 extension**](https://github.com/zerxiesderxies/sd-webui-gan-generator/), which was the initial inspiration for this project, and whose code has been an important guide throughout this process. Also author of the very helpful rentry.co guide [**'A men-only SD Webui Guide to running BroGAN'**](https://rentry.co/uoza8fqp), with a lot of info about BroGAN.
